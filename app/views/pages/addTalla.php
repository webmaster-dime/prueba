                                            ...
                                            <fieldset class="row">
                                                ...
                                                <div class="mb-3 col-12">
                                                    <label for="exampleFormControlSelect1"
                                                        ...
                                                        <p>
                                                            NOMBRE DEL GRUPO DE TALLAS
                                                            <strong class="text-danger">*</strong>
                                                            <a href="#" class="text-black" data-bs-toggle="tooltip"
                                                                data-bs-placement="top"
                                                                title="Selecciona un grupo de tallas">
                                                                <i class="mdi mdi-help-circle-outline"></i>
                                                            </a>
                                                        </p>
                                                        <a target="_blank" href="../pages/addTallaGrupo.php"
                                                            class="text-black" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="Registrar grupo de tallas">
                                                ...
                                                <div class="mb-3 col-12">
                                                    <label for="exampleFormControlSelect1" class="form-label">
                                                        ...
                                                        <a href="#" class="text-black" data-bs-toggle="tooltip"
                                                            data-bs-placement="top"
                                                            title="El nombre de la talla debe tener al menos 2 letras, puedes agregar multiples seprandolos por coma. Ej. 24,25">
                                                            <i class="mdi mdi-help-circle-outline"></i>
                                                        </a>
                                                    </label>

                                                ...
                                                <div class="mb-3 col-12">
                                                    <label for="exampleFormControlSelect1" class="form-label">
                                                        ...
                                                        <a href="#" class="text-black" data-bs-toggle="tooltip"
                                                            ...
                                                            title="El campo debe tener al menos 2 letras">
                                                            <i class="mdi mdi-help-circle-outline"></i>
                                                        </a>
                                                    </label>
                                                    <input type="text" required title="Campo necesario"
                                                        class="form-control" placeholder="Nombre del grupo de talla">
                                                </div>
                                            </fieldset>
                                            <!-- Botones -->

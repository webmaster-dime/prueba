                                            ...
                                            <fieldset class="row">
                                                ...
                                                <div class="mb-3 col-12">
                                                    <label for="name" class="form-label">
                                                        ...
                                                        <a href="#" class="text-black" data-bs-toggle="tooltip"
                                                            data-bs-placement="top"
                                                            title="El nombre corto de la unidad de medida debe tener al menos 1 letras. Ejem: KG">
                                                            <i class="mdi mdi-help-circle-outline"></i>
                                                        </a>
                                                    </label>
                                                    <input class="form-control" id="" required title="Campo necesario"
                                                        type="text">
                                                </div>
                                                <!--! campo 3  -->
                                                <div class="mb-3 col-12">
